# 喝過這麼多間咖啡廳，我讓 LINE Bot 幫我做了一本咖啡護照

這陣子，我陸續幫 LINE Cafe Bot 加上找咖啡廳、收藏、記錄造訪、群組投票和一起選時間等功能。

每一個功能都解決了一個當下的問題，但做到最後，我發現資料開始散落在不同地方：
...
於是這次，我和 Codex 一起完成了 [`line-cafe-passport`](https://github.com/zonawang/line-cafe-passport)，把原本分散的資料整理成一張「我的咖啡護照」。
...
## 最後一個功能，反而像替整個 Bot 寫了一篇回顧

咖啡護照沒有要求使用者多做一個步驟，而是讓以前留下的收藏、評分和足跡終於有了新的意義。
